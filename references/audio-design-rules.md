# 音频设计规则 · MyClaw Design

> 所有动画 demo 的音频应用配方。和 `sfx-library.md`（资产清单）配套使用。
> 实战锤炼：MyClaw Design 发布 hero v1-v9 迭代 · Anthropic 三支官方片子的 Gemini 深度拆解 · 8000+ 次 A/B 对比
...
MyClaw Design skill 自带 6 首 BGM（`assets/bgm-*.mp3`）：
...
### 配方 A · 产品发布 hero（MyClaw Design v9 同款）
```
时长：25 秒
...
- Anthropic 三支片子深度音频分析：参考 `AUDIO-BEST-PRACTICES.md`
- MyClaw Design v9 实战案例：参考 hero-animation-v9-final.mp4
