...
<p align="center">
  <img src="https://github.com/LeoYeAI/myclaw-design/releases/download/v1.0.0/hero-animation-v10-en.gif" alt="MyClaw Design Hero — タイプ → 方向選択 → ギャラリー → フォーカス → ブランドリビール" width="100%">
</p>
