...
<p align="center">
  <img src="https://github.com/LeoYeAI/myclaw-design/releases/download/v1.0.0/hero-animation-v10-en.gif" alt="MyClaw Design Hero — Tapez → Choisissez une direction → Galerie → Focus → Révélation de marque" width="100%">
</p>
