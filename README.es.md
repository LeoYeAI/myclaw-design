...
<p align="center">
  <img src="https://github.com/LeoYeAI/myclaw-design/releases/download/v1.0.0/hero-animation-v10-en.gif" alt="MyClaw Design Hero — Escribe → Elige dirección → Galería → Enfoque → Revelación de marca" width="100%">
</p>
